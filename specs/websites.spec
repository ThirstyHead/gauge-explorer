# Federal Websites Accessibility 

This is a list of federal websites. 
This test suite will visit each website's home page and test 
the accessibility of the page. It will also visit each website's 
Accessibility page. 
